...
| **Testing a change in the running game** — replaying an LFS scenario, recording one, reading a trace | `simulation_tests/README.md` (standalone, not part of the add-on) |
